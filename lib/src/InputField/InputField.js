...
`;
const FjInputFieldWrapper = styled.div([style]);
FjInputFieldWrapper.defaultProps = {
    theme
};


export function FjInputField({id, type, label, value, placeholder, onChange, error, required}) {
  return (
    <FjInputFieldWrapper>
